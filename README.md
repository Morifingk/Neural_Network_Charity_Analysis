...
### Data Preprocessing
1. What variable(s) are considered the target(s) for this model?    
Checking to see if the target is marked as successful in the DataFrame, indicating that it has been successfully funded by AlphabetSoup.  

2. What variable(s) are considered to be the features for this model?    
...
4. How many neurons, layers, and activation functions did I select for your neural network model, and why?    
...
5. what was the target model performance?   
The target for the model was 75%, but the best the model could produce was 72.7%.

6. What steps did I take to try and increase model performance?   
